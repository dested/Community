package com.minederp.community.games.advancedWar;
...
import com.minederp.community.games.communities.PlayerCacher;
...
import com.minederp.community.util.InventoryStash;
import com.minederp.community.util.PolygonPoint;

public class AdvancedWarContent {

	private CommunityPlugin plugin;
	...
	public AdvancedWarContent(AdvancedWarStep step, Town t, Town t2, CommunityPlugin plugin, GameLogic logic) {
		warStep = step;
		this.plugin = plugin;
		this.logic = logic;
	...
	private void processStep() {
		...
		case AcceptingSecondWager:
			...
			for (PlayerCacher kpc : myAttackingTown.townPlayers) {
				kpc.player
			...
			for (PlayerCacher kpc : myDefendingTown.townPlayers) {
				kpc.player
						.sendMessage(ChatColor.DARK_AQUA
								+ " War has been declared on the town "
