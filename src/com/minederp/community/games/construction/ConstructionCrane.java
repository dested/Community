package com.minederp.community.games.construction;
...
import com.minederp.community.util.Tuple2;
...
*/
	...
	private boolean drawCrane(List<BlockFace> armsz, boolean print, List<Location> ls) {
		...
		for (BlockFace arm : armsz) {
			...
			if (print) {
				constructionJob.game.logic.addBlockForReprint(new BlockReprintItem(bl.getX(), bl.getY(), bl.getZ(), bl.getTypeId(), bl.getData(), "crane"
						+ craneID));
