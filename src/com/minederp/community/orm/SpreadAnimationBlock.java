...
public class SpreadAnimationBlock {
	...
	public static List<SpreadAnimationBlock> getAllBySpreadAnimationBlockID(int aSpreadAnimationBlockID) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where SpreadAnimationBlockID="
	...
	public static SpreadAnimationBlock getFirstBySpreadAnimationBlockID(int aSpreadAnimationBlockID) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where SpreadAnimationBlockID=" + aSpreadAnimationBlockID
					+ "");
			if (fc.next())
	...
	public static List<SpreadAnimationBlock> getAllBySpreadAnimationID(int aSpreadAnimationID) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where SpreadAnimationID="
					+ aSpreadAnimationID + ""));
	...
	public static SpreadAnimationBlock getFirstBySpreadAnimationID(int aSpreadAnimationID) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where SpreadAnimationID=" + aSpreadAnimationID + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAllByFrameIndex(int aFrameIndex) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where FrameIndex=" + aFrameIndex
					+ ""));
	...
	public static SpreadAnimationBlock getFirstByFrameIndex(int aFrameIndex) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where FrameIndex=" + aFrameIndex + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAllByBlockX(int aBlockX) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where BlockX=" + aBlockX + ""));
	...
	public static SpreadAnimationBlock getFirstByBlockX(int aBlockX) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where BlockX=" + aBlockX + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAllByBlockY(int aBlockY) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where BlockY=" + aBlockY + ""));
	...
	public static SpreadAnimationBlock getFirstByBlockY(int aBlockY) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where BlockY=" + aBlockY + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAllByBlockZ(int aBlockZ) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where BlockZ=" + aBlockZ + ""));
	...
	public static SpreadAnimationBlock getFirstByBlockZ(int aBlockZ) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where BlockZ=" + aBlockZ + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAllByMaterialID(int aMaterialID) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where MaterialID=" + aMaterialID
					+ ""));
	...
	public static SpreadAnimationBlock getFirstByMaterialID(int aMaterialID) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where MaterialID=" + aMaterialID + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAllByDataID(int aDataID) {
		...
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where DataID=" + aDataID + ""));
	...
	public static SpreadAnimationBlock getFirstByDataID(int aDataID) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", "where DataID=" + aDataID + "");
			if (fc.next())
				return makeSpreadAnimationBlock(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimationBlock> getAll() {
		try {
			return loopThroughSpreadAnimationBlock(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimationBlock", ""));
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
		}
	...
	public void insert() {
		try {
			CommunityPlugin.wrapper.insertQuery("SpreadAnimationBlock", "default," + _SpreadAnimationID + ", " + _FrameIndex + ", " + _BlockX + ", "
	...
	public void update() {
		try {
			CommunityPlugin.wrapper.updateQuery("UPDATE SpreadAnimationBlock SET SpreadAnimationID= " + _SpreadAnimationID + " , FrameIndex= "
	...
	public void delete() {
		try {
			CommunityPlugin.wrapper.deleteQuery("SpreadAnimationBlock", "SpreadAnimationBlockID = " + _SpreadAnimationBlockID);
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
