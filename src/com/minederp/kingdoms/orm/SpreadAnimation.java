...
public class SpreadAnimation {
	...
	public static List<SpreadAnimation> getAllBySpreadAnimationID(int aSpreadAnimationID) {
		...
		try {
			return loopThroughSpreadAnimation(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimation", "where SpreadAnimationID="
					+ aSpreadAnimationID + ""));
	...
	public static SpreadAnimation getFirstBySpreadAnimationID(int aSpreadAnimationID) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimation", "where SpreadAnimationID=" + aSpreadAnimationID + "");
			if (fc.next())
	...
	public static List<SpreadAnimation> getAllByAnimationSpeed(int aAnimationSpeed) {
		...
		try {
			return loopThroughSpreadAnimation(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimation", "where AnimationSpeed=" + aAnimationSpeed
					+ ""));
	...
	public static SpreadAnimation getFirstByAnimationSpeed(int aAnimationSpeed) {
		try {
			ResultSet fc = CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimation", "where AnimationSpeed=" + aAnimationSpeed + "");
			if (fc.next())
				return makeSpreadAnimation(fc);
		} catch (SQLException e) {
			e.printStackTrace();
	...
	public static List<SpreadAnimation> getAll() {
		try {
			return loopThroughSpreadAnimation(CommunityPlugin.wrapper.selectQuery("*", "SpreadAnimation", ""));
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
		}
	...
	public void insert() {
		try {
			CommunityPlugin.wrapper.insertQuery("SpreadAnimation", "default," + _AnimationSpeed + "");
	...
	public void update() {
		try {
			CommunityPlugin.wrapper.updateQuery("UPDATE SpreadAnimation SET AnimationSpeed= " + _AnimationSpeed + " where SpreadAnimationID="
					+ _SpreadAnimationID + " ");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	...
	public void delete() {
		try {
			CommunityPlugin.wrapper.deleteQuery("SpreadAnimation", "SpreadAnimationID = " + _SpreadAnimationID);
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
